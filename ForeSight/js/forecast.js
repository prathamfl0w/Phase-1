window.Forecast = {
  ...
  calculateForecast: function (options) {
    ...
    const windowDays =
      options.windowDays !== undefined ? options.windowDays : 30;
    const z = options.z !== undefined ? options.z : 1.65;
    const reviewPeriodDays =
      options.reviewPeriodDays !== undefined ? options.reviewPeriodDays : 14;
    ...
    return {
      ...
      daysOfStockLeft:
        daysOfStockLeft !== null ? Math.round(daysOfStockLeft) : null,
